        ...
        <tr>
          <td style="background-color:#111;border-left:1px solid #222;border-right:1px solid #222;padding:40px;">
            ...
            <div style="text-align:center;margin-bottom:32px;">
              <a href="https://discord.gg/5btq6znUvN" style="display:inline-block;background-color:#5865F2;color:#fff;font-weight:800;font-size:15px;text-decoration:none;padding:14px 36px;border-radius:8px;">Contacter le support →</a>
            </div>
