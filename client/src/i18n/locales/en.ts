export const en = {
  ...
  purchase: {
    ...
    controllerOnlyDesc:
      "No Recoil works with controllers only (Xbox, PS5, Gamesir, etc.). Keyboard and mouse are not supported.",
  ...
  products: {
    ...
    weightDesc: "Paid additional AI Weight for Apex Legends and Fortnite. Improves targeting precision and AI tracking. ⚠️ Add-on only — FUSION IA license required separately.",
    weightWarning: "Add-on only. Extra paid weight — FUSION IA license required.",
    weightF1: "Apex Legends & Fortnite",
    weightF2: "Enhanced AI Targeting",
    weightF3: "Additional paid weight",
    ...
    jitterDesc: "The best No Recoil anti-recoil tool for Apex Legends, Fortnite and Warzone. Undetectable by anti-cheat, does not cut aim assist. Precise shots up to 150m+ with minimal shaking.",
  ...
  support: {
    ...
    faq9q: "Are No Recoil and AI Aimbot compatible with keyboard and mouse?",
  ...
  plans: {
    ...
    addonApexDesc: "Additional paid AI Weight for Apex Legends. ONLY for existing AI Aimbot license holders. Improves targeting precision.",
    addonFortnite: "Advanced Weight — Fortnite",
    addonFortniteDesc: "Additional paid AI Weight for Fortnite. ONLY for existing AI Aimbot license holders. Improves targeting precision.",
