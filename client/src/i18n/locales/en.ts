export const en = {
  ...
  products: {
    ...
    jitterF4: "Controller only",
    jitterF5: "Works with All FPS Games",
    onestateBadge: "iOS / ANDROID",
    onestateSubtitle: "Mobile AI Aimbot",
    onestateTitle: "AI Aimbot Onestate RP",
    onestateDesc:
      "AI Aimbot for iOS and Android via Onestate RP. No Waveshare board, no controller, and no keyboard/mouse required — mobile only.",
    onestateDonation:
  ...
  plans: {
    ...
    onestateDesc: "Mobile AI Aimbot for iOS & Android via Onestate RP. No RP2350A, controller, or keyboard/mouse required. This payment is a donation to the OneScript server — thank you!",
    perWeek: "/ week",
    perMonth: "/ month",
    dur1h: "~1 hour",
    dur5m: "~5 min",
