...
const products: ProductCard[] = [
  ...
  },
  {
    ...
    subtitle: "Apex & Fortnite Add-On",
    description: "Powerful AI Weight add-on for Apex Legends and Fortnite. Supercharges targeting precision and AI tracking. ⚠️ **Add-on only** — FUSION IA license required separately. NVIDIA RTX 4070/5060+ or AMD RX 7900/9060+ minimum.",
    icon: Zap,
