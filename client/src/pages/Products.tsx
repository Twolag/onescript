...
const products: ProductCard[] = [
  ...
  },
  {
    ...
    description: "Powerful AI Weight add-on for Apex Legends only. Supercharges targeting precision and AI tracking. ⚠️ **Add-on only** — FUSION IA license required separately. NVIDIA RTX 4080/5070+ or AMD RX 9070 XT+ minimum.",
    icon: Zap,
    ...
    features: [
      ...
      "NVIDIA RTX 4080/5070+ or AMD RX 9070 XT+",
      "Instant Delivery",
    ...
    warning: "Add-on only. FUSION IA license required. GPU: NVIDIA RTX 4080/5070+ or AMD RX 9070 XT+ minimum.",
  },
  {
    id: "windows-opt",
