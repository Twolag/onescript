...
const videoDemos: VideoDemo[] = [
  ...
  {
    id: "fusion-ai-fortnite-2",
    title: "FUSION IA — Fortnite #2",
    game: "Fortnite",
    product: "FUSION IA",
    description: "Another Fortnite gameplay showcase with FUSION IA — smooth tracking and competitive aim assist.",
    thumbnail: "/images/fortnite-thumb-3.jpg",
    videoUrl: "/videos/fortnite-clip-3.mp4",
    icon: Cpu,
    badge: "FORTNITE",
    accent: "from-cyan-500/30 via-transparent to-violet-tech/30",
    tags: ["Keyboard / Mouse", "Controller", "Undetectable", "Optimized"],
  },
  {
    id: "fusion-ai-apex",
  ...
  },
  {
    ...
    title: "FUSION IA — Warzone",
    game: "Warzone",
    product: "FUSION IA",
    description: "FUSION IA on Warzone — smooth tracking and competitive aim assist for BR fights.",
    thumbnail: "/images/warzone-thumb.jpg",
    videoUrl: "/videos/warzone-clip.mp4",
    icon: Crosshair,
    badge: "WARZONE",
  ...
  },
  {
    ...
    thumbnail: "/images/apex-adw-thumb.jpg",
    videoUrl: "/videos/apex-adw-clip.mp4",
    icon: Zap,
    badge: "ADD-ON",
    accent: "from-amber-500/30 via-transparent to-violet-tech/25",
  ...
  },
  {
    ...
    game: "Fortnite",
    product: "Advanced AI Weight",
    description: "Advanced AI Weight performance on Fortnite. Experience next-level precision and tracking. Additional paid weight — FUSION IA license required.",
