...
const gpuData = [
  ...
  { name: "AMD RX 6600 XT", tier: "Modern GPU", status: "compatible", note: "Native support in V7.4 — minimum AMD requirement" },
  { name: "AMD RX 6700 XT", tier: "Modern GPU", status: "recommended", note: "Excellent V7.4 performance" },
  { name: "AMD RX 6800 XT", tier: "High End", status: "recommended", note: "Outstanding V7.4 performance" },
