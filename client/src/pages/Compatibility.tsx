...
const gpuData = [
  ...
  { name: "AMD RX 6600 XT", tier: "Modern GPU", status: "compatible", note: "Native support in V7.6 — minimum AMD requirement" },
  { name: "AMD RX 6700 XT", tier: "Modern GPU", status: "recommended", note: "Excellent V7.6 performance" },
  { name: "AMD RX 6800 XT", tier: "High End", status: "recommended", note: "Outstanding V7.6 performance" },
  { name: "AMD RX 7600", tier: "Modern GPU", status: "compatible", note: "RDNA 3 — native support in V7.6" },
  { name: "AMD RX 7700 XT", tier: "High End", status: "recommended", note: "RDNA 3 — exceptional V7.6 performance" },
  { name: "AMD RX 7900 XT / XTX", tier: "High End", status: "recommended", note: "RDNA 3 — optimal V7.6 performance" },
