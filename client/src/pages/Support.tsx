...
const faqItems = [
  ...
  },
  {
    ...
    a: "For FUSION AI, refunds are only possible if your GPU is strictly below RTX 3060 (e.g., RTX 3050 or equivalent/inferior) AND the software does not function correctly after full optimization (including a Windows 10 reinstallation if necessary). No refund will be granted if recommended optimizations are refused. It is the customer's sole responsibility to ensure their hardware meets the necessary specifications before purchase. Purchases made with non-compliant configurations are considered final. Furthermore, no refund will be processed or accepted if the malfunction is due to the customer's PC (hardware, third-party software, drivers, non-compliant operating system, etc.) or its components. Refunds are only applicable if the malfunction is proven to be directly caused by the OneScript software itself. For other products, a 14-day refund policy applies if the product has not been used.", },
  {
