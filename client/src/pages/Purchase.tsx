                  ...
                  {(productId === "jitter-script" || productId === "ai-engine") && (
                    <div className="pt-4 border-t border-border/30">
                      ...
                      <div className="p-4 rounded-lg bg-blue-900/20 border border-blue-500/30 mb-4">
                        <p className="text-sm text-blue-200/90"><strong className="text-blue-400">⚠️ Important:</strong> This product is <strong>Controller Only</strong> — Keyboard & Mouse are not supported.</p>
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-foreground mb-2">Select Your Controller</label>
