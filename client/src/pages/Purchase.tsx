...
const SUMUP_LINKS: { [key: string]: string } = {
  ...
  "ai-engine-3": "https://pay.sumup.com/b2c/QK3BXCMA",   // 50€ — Monthly (License only)
  "ai-engine-4": "https://pay.sumup.com/b2c/Q8U1ZMJA",   // 80€ — Monthly (License + Inst.)
                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="text-right flex-shrink-0">
                          {productId === "ai-engine" && (idx === 3 || idx === 4) && (
                            <div className="mb-1">
                          ...
                          <p className={`font-display font-bold text-lg ${productId === "ai-engine" && (idx === 3 || idx === 4) ? 'text-red-500' : 'text-violet-tech'}`}>{option.price}€</p>
