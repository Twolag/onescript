            ...
            {[
              {
                ...
                description: "Revolutionary V8.1 update with exceptional AMD support. Now available on Apex Legends, Fortnite, Warzone, and more. Requires Waveshare RP2350A USB Mini Development Board. Native NVIDIA & AMD compatibility. Zero FPS drops.",
                icon: Cpu,
