          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Powerful AI Weight add-on for Apex Legends. Supercharges targeting precision. ⚠️ Add-on only. NVIDIA RTX 4070/5060+ or AMD RX 9070 XT+.",
                icon: Zap,
                badge: { label: "ADD-ON ONLY", color: "bg-amber-500/20 border-amber-500/50 text-amber-400" },
                features: ["Apex Exclusive", "Enhanced Targeting", "RTX 4070/5060+ or RX 9070 XT+", "Instant Delivery", "Requires FUSION IA"],
                price: "10 €",
                priceNote: "one-time",
                cta: "BUY",
