            ...
            {[
              {
                ...
                description: "Revolutionary V8.1 update with exceptional AMD support. Available on Apex Legends, Fortnite, Warzone, and Overwatch 2. Requires Waveshare RP2350A USB Mini Development Board. Native NVIDIA & AMD compatibility. Zero FPS drops.",
                icon: Cpu,
